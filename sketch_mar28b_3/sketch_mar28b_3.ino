...
void loop()
{
    ...
    RgbColor updatedColor = HslColor(random(360) / 360.0f, 1.0f, 0.25f);

    for (int i=0; i<150; i++)
    {
      strip1.SetPixelColor(i, colorGamma.Correct(updatedColor));
      strip2.SetPixelColor(i, colorGamma.Correct(updatedColor));
    }
